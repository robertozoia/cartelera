...
# This is a slightly modified version of imdbpie by Richard Asaurus (https://github.com/richardasaurus/imdb-pie)
# His version requires Python 3.3, I fixed it for Python 2.7
...
class Imdb:
    ...
    def find_by_title(self, title):
        ...
        query_params = urllib.urlencode(default_find_by_title_params)
